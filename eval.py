    ...
    for batch in tqdm(dataloader, disable=opts.no_progress_bar):
        ...
        with torch.no_grad():
            ...
            for f in model.fleet_info['order']:
                ...
                mask = mask.to(device)  # [batch_size, graph_size]
                if f == 1:
                    # f=1 时的特殊逻辑：不加10
...
if __name__ == "__main__":
    ...
    parser.add_argument("--datasets", nargs='+', default=["./data/agh/agh50_validation_seed4321.pkl", ], help="Filename of the dataset(s) to evaluate")
    ...
    parser.add_argument('--eval_batch_size', type=int, default=1, help="Batch size to use during (baseline) evaluation")
    parser.add_argument('--width', type=int, nargs='+',default=[1000],
    ...
    parser.add_argument('--model', type=str, default="./data/50")
